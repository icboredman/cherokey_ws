...
if("TRUE" STREQUAL "TRUE")
  set(minorucam_SOURCE_PREFIX /home/pi/cherokey_ws/src/minorucam)
  set(minorucam_DEVEL_PREFIX /home/pi/cherokey_ws/devel)
  ...
  set(minorucam_INSTALL_PREFIX /home/pi/cherokey_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'minorucam' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'minorucam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/cherokey_ws/src/minorucam/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
